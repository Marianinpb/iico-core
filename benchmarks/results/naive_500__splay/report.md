# Benchmark Report — naive_500__splay
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 46.1 | 566 | 0.1000 | 0.2000 | 0.0000 |
