# Benchmark Report — document__splay
...
| Métrica | Valor |
|---------|-------|
| Latencia promedio | 1.91 ms |
| Tokens de contexto promedio | 3525 |
| RAGAS Score promedio | 0.2364 |
| RAGAS P (Context Precision) | 0.1636 |
| RAGAS R (Context Recall) | 0.2545 |
| E_tok promedio | **228389.2** |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 20.7 | 3525 | 0.7000 | 0.6000 | 0.8000 |
| `q_hw_02` | ¿Cuál es la mejor estructura para evitar condicion... | 0.0 | 3525 | 0.8500 | 0.2000 | 0.9000 |
| `q_hw_03` | ¿Cómo se previene la desincronización al combinar ... | 0.0 | 3525 | 0.1000 | 0.2000 | 0.2000 |
| `q_ai_01` | ¿Por qué es necesario dividir por la raíz cuadrada... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_02` | ¿Cómo soluciona la arquitectura Transformer la imp... | 0.0 | 3525 | 0.9500 | 0.8000 | 0.9000 |
| `q_ai_03` | ¿Qué técnica se utiliza para evitar que el pipelin... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_04` | ¿Qué debe hacer un agente si se da cuenta de que l... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_01` | ¿Cómo determina el algoritmo de perturbación y obs... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_02` | ¿Cuál es la implicación física del término de corr... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_03` | ¿Por qué la solución analítica de las Ecuaciones d... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_04` | ¿Cuál es el compromiso (trade-off) de utilizar un ... | 0.0 | 3525 | 0.0000 | 0.0000 | 0.0000 |
