# Benchmark Report — semantic__splay
...
| Campo | Valor |
|-------|-------|
| Run ID | `semantic__splay` |
| Chunking | `semantic` |
| Retrieval | `splay` |
| Top-K | 5 |
| RAGAS | ✅ habilitado |
| Queries evaluadas | 11 |
| Tiempo total | 10045 ms |

### Performance

| Métrica | Valor |
|---------|-------|
| Latencia promedio | 5.11 ms |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 56.0 | 165 | 0.1000 | 0.2500 | 0.0000 |
