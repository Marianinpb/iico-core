# Benchmark Report — semantic+convolution__splay

> Generado: 2026-06-29 06:40

## Configuración

| Campo | Valor |
|-------|-------|
| Run ID | `semantic+convolution__splay` |
| Chunking | `semantic → convolution` |
| Retrieval | `splay` |
| Top-K | 5 |
| RAGAS | ✅ habilitado |
| Queries evaluadas | 11 |
| Tiempo total | 32109 ms |

### Performance

| Métrica | Valor |
|---------|-------|
| Latencia promedio | 4.77 ms |
| Tokens de contexto promedio | 165 |
| RAGAS Score promedio | 0.0091 |
| RAGAS P (Context Precision) | 0.0227 |
| RAGAS R (Context Recall) | 0.0000 |
| E_tok promedio | **15136.4** |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 52.2 | 165 | 0.1000 | 0.2500 | 0.0000 |
| `q_hw_02` | ¿Cuál es la mejor estructura para evitar condicion... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_hw_03` | ¿Cómo se previene la desincronización al combinar ... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_01` | ¿Por qué es necesario dividir por la raíz cuadrada... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_02` | ¿Cómo soluciona la arquitectura Transformer la imp... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_03` | ¿Qué técnica se utiliza para evitar que el pipelin... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_04` | ¿Qué debe hacer un agente si se da cuenta de que l... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_01` | ¿Cómo determina el algoritmo de perturbación y obs... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_02` | ¿Cuál es la implicación física del término de corr... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_03` | ¿Por qué la solución analítica de las Ecuaciones d... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_04` | ¿Cuál es el compromiso (trade-off) de utilizar un ... | 0.0 | 165 | 0.0000 | 0.0000 | 0.0000 |
