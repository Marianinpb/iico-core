# Benchmark Report — naive_200__embeddings
...
| Campo | Valor |
|-------|-------|
| Run ID | `naive_200__embeddings` |
| Chunking | `naive` |
| Retrieval | `embeddings` |
| Top-K | 5 |
| RAGAS | ✅ habilitado |
| Queries evaluadas | 11 |
| Tiempo total | 2520 ms |

### Performance

| Métrica | Valor |
|---------|-------|
| Latencia promedio | 51.88 ms |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 40.4 | 566 | 0.1000 | 0.2000 | 0.0000 |
| `q_hw_02` | ¿Cuál es la mejor estructura para evitar condicion... | 48.2 | 497 | 0.0000 | 0.0000 | 0.0000 |
| `q_hw_03` | ¿Cómo se previene la desincronización al combinar ... | 54.2 | 538 | 0.8500 | 0.6000 | 0.9000 |
| `q_ai_01` | ¿Por qué es necesario dividir por la raíz cuadrada... | 51.0 | 404 | 0.0000 | 0.2000 | 0.0000 |
| `q_ai_02` | ¿Cómo soluciona la arquitectura Transformer la imp... | 51.5 | 586 | 0.9500 | 0.6000 | 0.9000 |
| `q_ai_03` | ¿Qué técnica se utiliza para evitar que el pipelin... | 55.9 | 683 | 0.0000 | 0.2000 | 0.9000 |
| `q_ai_04` | ¿Qué debe hacer un agente si se da cuenta de que l... | 58.1 | 659 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_01` | ¿Cómo determina el algoritmo de perturbación y obs... | 53.2 | 812 | 0.9000 | 0.6000 | 0.9000 |
| `q_phys_02` | ¿Cuál es la implicación física del término de corr... | 54.8 | 804 | 0.9500 | 0.8000 | 0.9000 |
| `q_phys_03` | ¿Por qué la solución analítica de las Ecuaciones d... | 55.1 | 807 | 0.9000 | 0.6000 | 1.0000 |
| `q_phys_04` | ¿Cuál es el compromiso (trade-off) de utilizar un ... | 48.2 | 626 | 0.0000 | 0.0000 | 0.0000 |
