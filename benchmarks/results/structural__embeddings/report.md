# Benchmark Report — structural__embeddings
...
| Campo | Valor |
|-------|-------|
| Run ID | `structural__embeddings` |
| Chunking | `structural` |
| Retrieval | `embeddings` |
| Top-K | 5 |
| RAGAS | ✅ habilitado |
| Queries evaluadas | 11 |
| Tiempo total | 2659 ms |

### Performance

| Métrica | Valor |
|---------|-------|
| Latencia promedio | 53.08 ms |
| Tokens de contexto promedio | 913 |
| RAGAS Score promedio | 0.5864 |
| RAGAS P (Context Precision) | 0.3636 |
| RAGAS R (Context Recall) | 0.6182 |
| E_tok promedio | **25085.3** |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 54.8 | 821 | 0.6000 | 0.2500 | 0.6000 |
| `q_hw_02` | ¿Cuál es la mejor estructura para evitar condicion... | 53.6 | 729 | 0.0000 | 0.0000 | 0.0000 |
| `q_hw_03` | ¿Cómo se previene la desincronización al combinar ... | 54.0 | 399 | 0.9000 | 0.2000 | 0.9000 |
| `q_ai_01` | ¿Por qué es necesario dividir por la raíz cuadrada... | 52.2 | 1165 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_02` | ¿Cómo soluciona la arquitectura Transformer la imp... | 54.4 | 911 | 0.8500 | 0.6000 | 0.9000 |
| `q_ai_03` | ¿Qué técnica se utiliza para evitar que el pipelin... | 55.0 | 772 | 0.0000 | 0.0000 | 0.0000 |
| `q_ai_04` | ¿Qué debe hacer un agente si se da cuenta de que l... | 52.8 | 659 | 0.4000 | 0.2500 | 0.9000 |
| `q_phys_01` | ¿Cómo determina el algoritmo de perturbación y obs... | 48.4 | 1598 | 0.9500 | 0.9000 | 0.9000 |
| `q_phys_02` | ¿Cuál es la implicación física del término de corr... | 56.5 | 1089 | 0.9000 | 0.6000 | 1.0000 |
| `q_phys_03` | ¿Por qué la solución analítica de las Ecuaciones d... | 55.7 | 1075 | 1.0000 | 0.6000 | 1.0000 |
| `q_phys_04` | ¿Cuál es el compromiso (trade-off) de utilizar un ... | 46.5 | 827 | 0.8500 | 0.6000 | 0.6000 |
