# Benchmark Report — naive_200+convolution__embeddings
...
| Campo | Valor |
|-------|-------|
| Run ID | `naive_200+convolution__embeddings` |
| Chunking | `naive → convolution` |
| Retrieval | `embeddings` |
| Top-K | 5 |
| RAGAS | ✅ habilitado |
| Queries evaluadas | 11 |
| Tiempo total | 10060 ms |

### Performance

| Métrica | Valor |
|---------|-------|
| Latencia promedio | 55.76 ms |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 56.5 | 583 | 0.8500 | 0.4000 | 0.8000 |
| `q_hw_02` | ¿Cuál es la mejor estructura para evitar condicion... | 55.5 | 493 | 0.1000 | 0.2000 | 0.6000 |
| `q_hw_03` | ¿Cómo se previene la desincronización al combinar ... | 63.5 | 145 | 0.8500 | 0.6000 | 0.9000 |
| `q_ai_01` | ¿Por qué es necesario dividir por la raíz cuadrada... | 54.7 | 324 | 0.9500 | 0.6000 | 0.9000 |
| `q_ai_02` | ¿Cómo soluciona la arquitectura Transformer la imp... | 54.8 | 531 | 0.8500 | 0.6000 | 0.8000 |
| `q_ai_03` | ¿Qué técnica se utiliza para evitar que el pipelin... | 58.1 | 352 | 0.9000 | 0.2000 | 0.3000 |
| `q_ai_04` | ¿Qué debe hacer un agente si se da cuenta de que l... | 56.3 | 478 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_01` | ¿Cómo determina el algoritmo de perturbación y obs... | 51.2 | 546 | 0.9500 | 0.9000 | 1.0000 |
| `q_phys_02` | ¿Cuál es la implicación física del término de corr... | 52.1 | 574 | 0.9500 | 0.6000 | 0.9000 |
| `q_phys_03` | ¿Por qué la solución analítica de las Ecuaciones d... | 57.7 | 579 | 0.0000 | 0.0000 | 0.0000 |
| `q_phys_04` | ¿Cuál es el compromiso (trade-off) de utilizar un ... | 53.0 | 295 | 0.0000 | 0.0000 | 0.0000 |
