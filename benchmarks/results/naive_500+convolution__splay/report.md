# Benchmark Report — naive_500+convolution__splay
...
| Campo | Valor |
|-------|-------|
| Run ID | `naive_500+convolution__splay` |
| Chunking | `naive → convolution` |
| Retrieval | `splay` |
| Top-K | 5 |
| RAGAS | ✅ habilitado |
| Queries evaluadas | 11 |
| Tiempo total | 8002 ms |
...
|----|-------|---------|--------|-------|---------|---------|
| `q_hw_01` | ¿Qué consideraciones de interfaz se deben tener al... | 51.5 | 583 | 0.8500 | 0.4000 | 0.8000 |
